...
@Disabled
@Autonomous(name = "Auton_SingleSkystone")
//@Disabled
public class Auton_SingleSkystone extends OpMode{
    ...
    public void loop() {
        ...
        switch(step) {
            ...
            case -2:
                ...
                break;
            case -1:
                //maybe say gyroTarget *= -1 to make it go the other way?
            ...
            case 0:
                ...
                if (flReached && frReached && blReached && brReached) {
                    ...
                    //uses PID control to adjust the power based on the position relative to the target
                    /**
                     correctAngle();
                     */
            ...
            case 13:
                ...
                largeDistance = true;
                DriveTrain(dist);
                targetPosition = calculateTicks(dist);
                step = 0;
                nextStep = 14;
                break;
            //deliver the stones
            ...
            case 19:
                ...
                DriveTrain(dist - 30 - addDist); //go back a negative amount
                targetPosition = calculateTicks(dist - 30 - addDist);
                step = 0;
                nextStep = 20;
                break;
            case 20:
                ...
                break;
            case 21:
                DriveTrain(7); //we have one case to drive up to the block at full power
                targetPosition = calculateTicks(7);
                step = 0;
                nextStep = 22;
                break;
            ...
            case 25:
                largeDistance = true;
                DriveTrain(-dist + 27 + addDist); //now go forward, in the opposite direction
                targetPosition = calculateTicks(-dist + 27 + addDist);
                step = 0;
                nextStep = 29;
                break;
            case 26:
            ...
            case 29:
                largeDistance = false;
                //wait after the long distance
                DriveTrain(-12); //now drive under the bridge
                targetPosition = calculateTicks(-12);
                step = 0;
                nextStep = 30;
                break;
            case 30:
