...
@Autonomous(name = "AutonLeftPark_Location:High")

public class AutonLeftPark_Location_High extends OpMode{
    ...
    //public double Turn
    public void strafe(int distance) { //if positive, forwards. if negative, backwards
        double power = .65;
        double circumTraveled = (distance / wheelCircum);
        int position = (int) (ticksPerTurn * circumTraveled);
        position = 1120;
        //position = (int) (position / (1/Math.sqrt(2)*(0.707)));
    ...
    public void loop() {
        ...
        switch(step) {
            ...
            case 0:
                ...
                break;
            case 1:
                strafe(5); //test forward/backward
                nextStep = 2;
                step = 0;
                break;
        }
