...
public class BasicOpMode_Iterative_Strafe extends OpMode
{
    ...
    public void loop() {
        ...
        if (gamepad1.left_bumper && speedFactor >= 0.25 && lastPressed!=gamepad1.left_bumper) {
            speedFactor -= .2;
        } else if (gamepad1.right_bumper && speedFactor <= 0.25 && lastPressed!=gamepad1.right_bumper) {
            speedFactor += .2;
        }
        lastPressed = gamepad2.left_bumper || gamepad2.right_bumper;
