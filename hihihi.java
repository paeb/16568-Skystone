...
@Autonomous(name = "Auton_Skystone2")
...
public class BlockDetection extends OpMode{
    ...
    public void loop() {
        ...
        switch(step) {
            case -2:
                DriveTrain(-3);
                targetPosition = calculateTicks(-3);
                step = 0;
                nextStep = 7;
                break;
            case -1:
            ...
            case 1:
                ...
                break;
            case 2:
                gyroCorrect(-86); //changed to opposite bc
                gyroTarget = -86;
                step = -1;
                nextStep = 3;
                break;
            ...
            case 4: //no stop and reset here, so there is not a problem
                ...
                if (skystoneOffset != 696969.69) { //if it was recognized, there will be offset not equal to 696969.69
                    ...
                    DriveTrain(-7); //if not recognized, drive left a little
                    targetPosition = calculateTicks(-7);
                    step = 0;
                    nextStep = 6; //come back to this case, to recognize block
                    toBridgeDist += 7; //7 inches offset
            ...
            case 8:
                ...
                DriveTrain(9); //now go towards the block to pick it up
                targetPosition = calculateTicks(9);
                step = 0;
                nextStep = 16;
                break;
            /**
            ...
            case 9:
                ...
                break;
            case 10:
                gyroCorrect(-86); //turns towards the bridge now
                gyroTarget = -86;
                step = -1;
            ...
            case 11: //drives towards the bridge
                 ...
                 */
                encoderMovedPosition = toBridgeDist;
                //block detection
                ...
                break;
            /**
             * these cases are useless, for the second block
             */
            case 12:
